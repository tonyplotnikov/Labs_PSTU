...
int variant(int g)
{
    ...
    if (g == 1)
    {
        ...
        do
        {
            cout << "1.Ôîðìèðîâàíèå ñïèñêà\n";
            cout << "2.Ïå÷àòü ñïèñêà\n";
            cout << "3.Óäàëèòü èç ñïèñêà ïîñëåäíèé ýëåìåíò ñ ÷åòíûì èíôîðìàöèîííûì ïîëåì\n";
            cout << "4.Óäàëåíèå ñïèñêà èç ïàìÿòè\n";
            cout << "5.Âûõîä\n";
            cin >> p;
            switch (p)
            {
            case 1:
            {
                cout << "Ââåäèòå êîëè÷åñòâî ýëåìåíòîâ ñïèñêà: ";
                cin >> n;
                make_odin(beg, n);
                break;
            }
    ...
    else if (g == 2)
    {
        ...
        do
        {
            cout << "1.Ôîðìèðîâàíèå ñïèñêà\n";
            cout << "2.Ïå÷àòü ñïèñêà\n";
            cout << "3.Äîáàâëåíèå â ñïèñîê ýëåìåíòà ñ çàäàííûì íîìåðîì\n";
            cout << "4.Óäàëåíèå ñïèñêà èç ïàìÿòè\n";
            cout << "5.Âûõîä\n";
            cin >> p;
            switch (p)
            ...
            case 3:
            {
                cout << endl << "Ââåäèòå íîìåð ýëåìåíòà:";
                cin >> k;
                add_dva(first, k);
                break;
            }
    ...
    else if (g == 3)
    {
        ...
        do
        {
            cout << "1.Ôîðìèðîâàíèå ñòåêà\n";
            cout << "2.Ïå÷àòü ñòåêà\n";
            cout << "3.Äîáàâëåíèå â ñòåê ýëåìåíòà ñ çàäàííûì íîìåðîì\n";
            cout << "4.Óäàëåíèå ñòåêà èç ïàìÿòè\n";
            cout << "5.Âûõîä\n";
            cin >> p;
            switch (p)
            {
            case 1:
            {
                cout << "Ââåäèòå êîëè÷åñòâî ýëåìåíòîâ ñòåêà:";
                cin >> n;
    ...
    else if (g == 4)
    {
        ...
        do
        {
            cout << "1.Ôîðìèðîâàíèå î÷åðåäè\n";
            cout << "2.Ïå÷àòü î÷åðåäè\n";
            cout << "3.Äîáàâëåíèå â î÷åðåäü ýëåìåíòà ñ çàäàííûì íîìåðîì\n";
            cout << "4.Óäàëåíèå î÷åðåäè èç ïàìÿòè\n";
            cout << "5.Âûõîä\n";
            cin >> p;
            switch (p)
            {
            case 1:
            {
                cout << "Ââåäåèòå êîëè÷åñòâî ýëåìåíòîâ î÷åðåäè:";
                cin >> n;
        ...
        cout << "íåò òàêîãî íîìåðà çàäàíèÿ";
    return 0;
}
#endif